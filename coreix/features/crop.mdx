...
<AccordionGroup>
    <Accordion title="演示：左上角顶边，截取原图 500 宽、500 高 的区域" icon="hand-back-point-right">
        ...
        <Frame>![crop-mode-demo-1.png](https://fanfan.s3.bitiful.net/static/docs/rect-demo-1.png?w=200&fmt=webp&q=90)</Frame>
        </Accordion>
    加上参数后 URL：[https://fanfan.s3.bitiful.net/girl.jpeg? **rect=0,0,500,500**](https://fanfan.s3.bitiful.net/girl.jpeg?rect=0,0,500,500)
    <Frame>![girl.resize.jpg](https://fanfan.s3.bitiful.net/girl.jpeg?rect=0,0,500,500)</Frame>
    </Accordion>
    ...
    **所以**：按照[图片缩略逻辑](resize.md#用例说明)单独设定 w=500，系统会按**`rect 结果图像的宽高比`**（而非`原图的宽高比`）自动设定缩略高度。
    加上参数后 URL：[https://fanfan.s3.bitiful.net/girl.jpeg? **rect=0,0,1000,1000 & w=500**](https://fanfan.s3.bitiful.net/girl.jpeg?rect=0,0,1000,1000&w=500)
    <Frame>![girl.resize.jpg](https://fanfan.s3.bitiful.net/girl.jpeg?rect=0,0,1000,1000&w=500)</Frame>
    </Accordion>
</AccordionGroup>