...
<AccordionGroup>
    ...
    加上参数后 URL: [https://fanfan.s3.bitiful.net/bridge.jpeg? **`txt=Bitiful`**](https://fanfan.s3.bitiful.net/bridge.jpeg?txt=Bitiful&fmt=png)
    <Frame>![bridge.txt.jpg](https://fanfan.s3.bitiful.net/bridge.jpeg?txt=Bitiful&fmt=png)</Frame>
    </Accordion>
    <Accordion title="演示 2: 将上面的水印放在图片底部居中**并推出边界**；字号自动调整到约为原图的 **55%**；透明度为 3%" icon="hand-back-point-right">
    加上参数后 URL: [https://fanfan.s3.bitiful.net/bridge.jpeg?txt=Bitiful& **`txt-size=0.55 & txt-pos=0.5,*0.96 & txt-alpha=0.03`**](https://fanfan.s3.bitiful.net/bridge.jpeg?txt=Bitiful&txt-size=0.55&txt-pos=0.5,*0.96&txt-alpha=0.03&fmt=png)
    <Frame>![bridge.txt.jpg](https://fanfan.s3.bitiful.net/bridge.jpeg?txt=Bitiful&txt-size=0.55&txt-pos=0.5,*0.96&txt-alpha=0.03&fmt=png)</Frame>
    </Accordion>
    <Accordion title="演示 3: 将水印略微缩小并移至原图中央，然后为文字水印加上**三个颜色**，以从**左到右渐变**；完全不透明" icon="hand-back-point-right">
    > 将图片模糊是为了更好地观察水印
    加上参数后 URL: [https://fanfan.s3.bitiful.net/bridge.jpeg?txt=Bitiful&blur=50& **`txt-size=0.3 & txt-pos=0.5,*0.5 & txt-color=03FF76,FFE05B,03FFFE`**](https://fanfan.s3.bitiful.net/bridge.jpeg?blur=50&txt=Bitiful&txt-size=0.3&txt-pos=0.5,0.5&txt-color=03FF76,FFE05B,03FFFE&fm=png)
    <Frame>![bridge.txt.jpg](https://fanfan.s3.bitiful.net/bridge.jpeg?blur=50&txt=Bitiful&txt-size=0.3&txt-pos=0.5,0.5&txt-color=03FF76,FFE05B,03FFFE&fm=png)</Frame>
    </Accordion>
</AccordionGroup>