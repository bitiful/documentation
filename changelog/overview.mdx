...
<Update label="2026/08/10" description="新增">
  ## 自动证书PRO & 对象存储网站 功能上线

  ![Autocert-Websites](https://files.bitiful.com/images/AutoCert-Websites.svg?w=1280&fmt=png)
...
<Update label="2026/06/22" description="增强">
  ## CoreIX V3.0 上线

  ![CoreIXV2](https://demo.bitiful.com/docs/CoreIXV3.0.svg?w=1200&fmt=tpng)
  ...
  3. **准确度**
     ...
     - 大幅优化 **hdr-rate** 参数作用于 **原生 HDR 方案图像** 中的准确度（_mark-hdr-rate 参数依旧只能调整 GainMap 方案图像中的水印亮度_）；
  ...
  | :-: | :-: |
  | <img src="https://demo.bitiful.com/raw/nikon.nef?w=1280" alt="HDR" /> | <img src="https://demo.bitiful.com/raw/nikon.nef?w=1280&hdr-rate=0%25" alt="HDR" /> |
...
<Update label="2026/05/10" description="公告">
  ## 📢 政策调整预告
...
<Update label="2026/04/21" description="增强">
  ## CoreIX V2.5 上线

  ![CoreIXV2](https://demo.bitiful.com/docs/CoreIXV2.5.svg?w=1200&fmt=tpng)
  ...
  1. **兼容的GainMap格式**：
     ...
     - OPPO **`高效 HEIC`** 直出照片；
  2. **HDR 相关参数**；
     - 新增 **hdr-rate** 参数，限制 HDR 亮度（防止部分 HDR 照片过于刺眼），支持 `绝对值` 和 `百分比` 两种值，_该参数仅对 GainMap HDR 有效_；
     ...
     - 新增 **mark-hdr-rate** 参数，设置 GainMap HDR 照片中的水印亮度，传入值为 `百分比`，默认 50% —— 即：原图最高亮度的“一半”，防止水印过亮，破坏原图预期效果，_该参数仅对 GainMap HDR 有效_；
  ...
  | :-: | --- | :-: |
  | <img src="https://demo.bitiful.com/hdr-img/oppo_hdr.jpg?w=840" alt="HDR" /> | <img src="https://demo.bitiful.com/hdr-img/oppo_hdr.jpg?w=840&hdr-rate=70%25" alt="HDR" /> | <img src="https://demo.bitiful.com/hdr-img/oppo_hdr.jpg?w=840&hdr-rate=0" alt="HDR" /> |

  | 完整亮度水印 | 70% 亮度水印 | SDR 亮度水印 |
  | :-: | --- | :-: |
  | <img src="https://demo.bitiful.com/hdr-img/oppo_hdr.jpg?w=840&txt=HDR%E6%B0%B4%E5%8D%B0&txt-pos=0.5,0.2&txt-size=0.3&mark-hdr-rate=100%25" alt="HDR" /> | <img src="https://demo.bitiful.com/hdr-img/oppo_hdr.jpg?w=840&txt=HDR%E6%B0%B4%E5%8D%B0&txt-pos=0.5,0.2&txt-size=0.3&mark-hdr-rate=70%25" alt="HDR" /> | <img src="https://demo.bitiful.com/hdr-img/oppo_hdr.jpg?w=840&txt=HDR%E6%B0%B4%E5%8D%B0&txt-pos=0.5,0.2&txt-size=0.3&mark-hdr-rate=0%25" alt="HDR" /> |
...
<Update label="2026/03/08" description="公告">
...
<Update label="2025/09/11" description="增强/调整">
  ## S4 对象存储更新 🎉
...
<Update label="2025/08/31" description="重构">
  ...
  **做全球最好的图片实时处理 API** —— 这是开发 CoreIX 的初衷
  ...
  | --- | --- | --- | --- |
  | <img src="https://demo.bitiful.com/tone-mapping/proraw_direct.jpeg" alt="raw" /> | <img src="https://demo.bitiful.com/tone-mapping/proraw_old_postprocessing.jpeg" alt="raw" /> | <img src="https://demo.bitiful.com/tone-mapping/proraw_new_postprocessing.jpeg" alt="raw" /> | <img src="https://demo.bitiful.com/tone-mapping/notsupported.png" alt="raw" /> |
  | 丢失暗部细节 | **暗部色彩崩坏**<br />**天空全面过曝** | **压制高光的**<br />**还原窗帘光泽** | 格式处理失败 |
...
<Update label="2025/07/13" description="公告">
  ...
  <Tip>
    **省流：**<br />不影响任何服务稳定性，不影响存储数据安全<br />少算的费用 **不会追缴**；多算的费用将 **单独补偿**。
  </Tip>
...
<Update label="2025/05/14" description="上新">
  ...
  **支持域名证书全流程自动处理：签发、续期、托管、更换**
  ...
  <Frame>
    <video autoplay={true} controls={true} className="w-full aspect-video" poster="https://bitiful-contents.s3.bitiful.net/videos%2Fbitiful-auto-certs-high.mp4?frame=1&w=1280" src="https://bitiful-contents.s3.bitiful.net/videos%2Fbitiful-auto-certs-high.mp4" />
  </Frame>
</Update>
...
<Update label="2024/06/21" description="独创">
  ...
  <Frame>
    <video autoplay={true} muted={true} controls={true} className="w-full aspect-video" poster="https://bitiful-contents.s3.bitiful.net/videos/with-simul-transfer.mp4?frame=1&w=1280" src="https://bitiful-contents.s3.bitiful.net/videos/with-simul-transfer.mp4" />
  </Frame>
