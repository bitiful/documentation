...
<Update label="2026/02/08" description="公告">
  ## 📢 价格调整预告
  ...
  | ---------------- | --------- | ------------------- |
  | `0 ~ 10`         | **免费（含 https）** | -   |
  | `11 ~ 1000 `     | 0.18 元/GB |  5折  |
  | `1001 ~ 10000`   | 0.14 元/GB |  5折  |
  | `10001 ~ 100000` | 0.12 元/GB |  5折  |
  | `100000 + `      | 0.09 元/GB |  5折  |

  <Warn>
    CDN 流量包价格 **暂不调整 低至 0.728/GB**： https://console.bitiful.com/billing/resource
  </Warn>
  ...
  <Tip>
    CDN 请求包低至 **暂不调整 低至 0.09元/亿次**： https://console.bitiful.com/billing/resource
  </Tip>
  ...
  | `0 ~ 10`         | **免费**    | -     |
  | `11 ~ 1000 `     | 0.18 元/GB | 5折 |
  | `1001 ~ 10000`   | 0.16 元/GB | 5折 |
  | `10001 ~ 100000` | 0.14 元/GB | 5折 |
  | `100000 + `      | 0.12 元/GB | 5折 |

  <Warn>
    CDN 请求包低至 **0.09元/亿次**： https://console.bitiful.com/billing/resource
  </Warn>
