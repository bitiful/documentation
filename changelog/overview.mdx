...
<Warning>单个大文件的 `Copy + 校验` 过程很可能 **长达 10 秒** 以上，在部分场景中会 **严重降低整体性能**。而 Move 操作耗时可 **低至 1 毫秒**。</Warning>
...
<Info>例如：阿里云 OSS **控制台** 和 **CopyObject** 不能 [重命名大于 1 GB 对象](https://help.aliyun.com/zh/oss/developer-reference/copyobject)</Info>
</Update>
...
<Warning>请务必保持控制台中正确的 CNAME 记录。</Warning>
</Update>
