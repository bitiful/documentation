...
<Update label="2026/05/10" description="公告">
  ...
  1. S4 对象存储不再能直接绑定域名对外服务，请启用“静态 CDN”；
  2. 预计从 5 月 15 日起，S4 对象存储不能直接对外提供 “ipa/apk” 下载服务，请启用“静态 CDN”；
  3. 从 5 月 11 日起 S4 对象存储将进行单线程限速： a. 普通文件默认限速 5MB/s； b. 针对 “ipa/apk” 文件最高下载速度限制为 1MB/s（15 日后将无法再公开下载 apk/ipa，仅支持通过“静态 CDN”下载）；

  <Tip>
    请启用 CDN 以获得更高的下载速度及资源加载性能
  </Tip>
</Update>
...
<Update label="2026/03/08" description="公告">
  ...
  | --- | --- | --- |
  | `0 ~ 10` | **免费（含 https）** | - |
  | `11 ~ 1000 ` | 0.18 元/GB | 6折 |
  | `1001 ~ 10000` | 0.14 元/GB | 6折 |
  | `10001 ~ 100000` | 0.12 元/GB | 6折 |
  | `100000 + ` | 0.10 元/GB | 6折 |

  <Warning>
    CDN 流量包价格 **暂不调整 低至 0.728/GB**： [https://console.bitiful.com/billing/resource](https://console.bitiful.com/billing/resource)
  </Warning>
  ...
  <Tip>
    CDN 请求包低至 **暂不调整 低至 0.09元/亿次**： [https://console.bitiful.com/billing/resource](https://console.bitiful.com/billing/resource)
  </Tip>
